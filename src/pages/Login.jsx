...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <form
        className="bg-white text-gray-500 max-w-[550px] w-full mx-4 md:p-6 p-4 py-8 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10"
      ...
      >
        ...
        <p className="text-center mt-4">
          ...
          <Link to={"/register"} className="text-blue-500 underline ms-3">
            Signup
          </Link>
        </p>
      </form>
